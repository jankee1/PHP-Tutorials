...
/* post/show.html.twig */
class __TwigTemplate_310094aad6389887dcd02ea8b90ec0f452da46ad46149d393d03dc377ad9f929 extends Template
{
    private $source;
    private $macros = [];
    ...
    <img src=\"";
        // line 7
        echo twig_escape_filter($this->env, ("/uploads/" . twig_get_attribute($this->env, $this->source, (isset($context["post"]) || array_key_exists("post", $context) ? $context["post"] : (function () { throw new RuntimeError('Variable "post" does not exist.', 7, $this->source); })()), "image", [], "any", false, false, false, 7)), "html", null, true);
        echo "\" alt=\"\">
";
...
{% endblock %}", "post/show.html.twig", "C:\\xampp\\htdocs\\PHP-Tutorials\\sfcourse\\templates\\post\\show.html.twig");
    }
}
